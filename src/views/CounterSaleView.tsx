              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs w-full min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <input
                    ...
                    className="w-full min-w-0 box-border px-3.5 py-2.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-semibold text-slate-900 dark:text-slate-100 focus:outline-none focus:border-blue-500"
                  />
                  <span className="text-[10px] text-slate-400 dark:text-slate-500 mt-1 block">Optional for walk-in customers</span>
                </div>
              </div>
            </div>
