...
export const PremiumMinimal: React.FC<InvoiceTemplateProps> = ({
  invoice,
  business,
  customer,
  branding,
  ...
  return (
    <div style={containerStyle} className="relative transition-all">
      ...
      <div className="h-1 bg-gradient-to-r from-amber-300 via-amber-500 to-amber-300 mb-6 rounded-full"></div>

      {/* Luxury Minimal Header */}
      <div className="flex justify-between items-start pb-6 mb-6 border-b border-amber-200/60 break-inside-avoid">
        <div>
        ...
        <div className="text-right">
          <span className="text-[10px] font-bold tracking-widest text-amber-700 uppercase border border-amber-300 px-3 py-1 rounded-full">
            EXECUTIVE TAX INVOICE
          </span>
      ...
      {/* Recipient Details */}
      <div className="p-4 rounded-xl bg-amber-50/30 border border-amber-200/60 mb-6 flex justify-between items-center break-inside-avoid">
        <div>
          <span className="text-[9px] font-bold text-amber-800 uppercase tracking-widest">PREPARED FOR</span>
        ...
        <div className="text-right">
          <span className="text-[9px] font-bold text-amber-800 uppercase tracking-widest">TOTAL VALUE</span>
          <p className="text-xl font-bold text-slate-900">{formatCurrency(invoice.grandTotal, currency)}</p>
        </div>
      </div>

      {/* Line Table */}
      <div className="mb-6 overflow-hidden rounded-xl border border-amber-200/60">
        <table className="w-full text-left border-collapse text-xs">
          <thead>
            <tr className="bg-slate-900 text-amber-400 text-[10px] font-bold uppercase">
              <th className="p-3">#</th>
      ...
      <div className="grid grid-cols-2 gap-6 mb-6 text-xs break-inside-avoid">
        ...
        <div className="p-4 rounded-xl bg-amber-50/40 border border-amber-200/60 space-y-2 text-right">
          ...
          <div className="pt-2 border-t border-amber-300 flex justify-between items-center text-sm font-black" style={{ color: primaryColor }}>
