-- ============================================================================
-- MIGRATION 023: FIX AUTHORITATIVE STOCK RPC RECONCILIATION & DEDUCTION
-- ============================================================================

-- 1. RE-DEFINE AUTHORITATIVE PRODUCT STOCK HELPER FUNCTION
-- Evaluates the maximum between products.current_stock and active stock_receipts sum.
-- Prevents 0 stock returns when products table contains positive inventory.
...
BEGIN
    ...
    -- Fetch current_stock directly from products table
...
-- 2. RE-DEFINE ATOMIC INVOICE STOCK FINALIZATION RPC FUNCTION
...
DECLARE
    ...
    v_new_authoritative_stock NUMERIC;
BEGIN
    ...
    LOOP
        IF v_item.product_id IS NOT NULL THEN
            ...
            -- Deduct products.current_stock directly
